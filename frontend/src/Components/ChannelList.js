    ...
    <MainFrame>
      ...
      {!loading &&
        ...
        data.GetChannels.channels.map((val, idx) =>
          <Channel key={idx}># {val.id} {val.channelName}</Channel>
        )}
      ...
      <CreateChannelFrame>
        <CreateChannelInput placeholder="input new channel" value={channelName} onChange={e => setChannelName(e.target.value)} />
